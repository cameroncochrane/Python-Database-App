...
class User(Base):
    ...
    def __repr__(self) -> str: # Table 'representation'
        return f"<User(id={self.id},username={self.username},email={self.email})>" # Map column names to the defined columns above
...
def main():
    ...
    user_1 = User(username="Cameron",email="cameron@mail.com") # Define a new row for the 'User' table
    user_2 = User(username="John",email="john@mail.com") # Define a second new row for the 'User' table
